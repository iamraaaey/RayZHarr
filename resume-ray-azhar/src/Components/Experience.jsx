        ...
        <Box id="experience">
            ...
            <Stack spacing={3}>
                {experiences.map((exp) => (
                    ...
                    >
                        <Typography sx={{ fontWeight: 700, color: '#f1f5f9', fontSize: '1rem', mb: 0.5 }}>
                            {exp.role}
                        </Typography>
                        ...
                        <Stack direction="row" spacing={2} flexWrap="wrap" sx={{ mb: 1.5 }}>
                            <Stack direction="row" spacing={0.5} alignItems="center">
                                <CalendarIcon sx={{ fontSize: '0.9rem', color: '#64748b' }} />
                        ...
                        <Box component="ul" sx={{ pl: 2, m: 0, mb: 2 }}>
                            {exp.highlights.map((item) => (
                                <Box
                                    component="li"
                                    key={item}
                                    sx={{ color: '#cbd5e1', fontSize: '0.85rem', lineHeight: 1.8 }}
                                >
                                    {item}
                                </Box>
                            ))}
