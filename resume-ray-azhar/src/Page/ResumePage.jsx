                    ...
                    <Box sx={{ flex: 1 }}>
                        <Typography
                            ...
                            sx={{
                                ...
                                background: isDark
                                    ? `linear-gradient(135deg, #f1f5f9, ${accentColor})`
                                    : `linear-gradient(135deg, #1e293b, ${accentColor})`,
                        ...
                        <Typography sx={{ color: 'text.secondary', fontSize: '0.88rem', mb: 1.5 }}>
                                ...
                                <Box component="ul" sx={{ pl: 2.5, mt: 1, mb: 1.5, m: 0, listStyle: 'none' }}>
                                    {exp.highlights.map((item, i) => (
                                        <Box component="li" key={i}
                                            sx={{ display: 'flex', alignItems: 'baseline', gap: 1, color: 'text.secondary', fontSize: '0.88rem', lineHeight: 1.85, mb: 0.4 }}>
                                    ...
                                    <Stack direction="row" flexWrap="wrap" gap={0.8} sx={{ mt: 1 }}>
                                        {exp.tags.map((tag) => (
                                            <Chip key={tag} label={tag} size="small"
                                                sx={{ bgcolor: `${exp.color || accentColor}18`, color: 'text.primary', border: `1px solid ${exp.color || accentColor}30`, fontSize: '0.72rem' }} />
                                        ))}
                                    </Stack>
                                )}
                            </Box>
                                ...
                                <Box component="ul" sx={{ pl: 0, mt: 1, mb: 0, listStyle: 'none' }}>
                                    {edu.highlights.map((item, j) => (
                                        <Box component="li" key={j}
                                            sx={{ display: 'flex', alignItems: 'baseline', gap: 1, color: 'text.secondary', fontSize: '0.88rem', lineHeight: 1.85, mb: 0.3 }}>
                        ...
                        <Stack direction="row" flexWrap="wrap" gap={0.8}>
                            {person.softSkills.map((skill) => (
                                <Chip key={skill} label={skill} size="small"
                                    sx={{ bgcolor: `${accentColor}15`, color: 'text.primary', border: `1px solid ${accentColor}30`, fontSize: '0.76rem' }} />
                            ))}
                        </Stack>
                    </Box>
                </Box>
                    ...
                    <Stack spacing={2.5}>
                        {person.achievements.map((ach, i) => (
                            ...
                            >
                                ...
                                <Box>
                                    <Typography sx={{ fontWeight: 700, color: 'text.primary', fontSize: '0.95rem', lineHeight: 1.4 }}>
                                        {ach.title}
                                    </Typography>
                                    <Typography sx={{ color: 'text.disabled', fontSize: '0.85rem', lineHeight: 1.7, mt: 0.2 }}>
                                        {ach.desc}
                                    </Typography>
                                </Box>
                            </Box>
                            ...
                            <Grid item xs={12} sm={6} key={i}>
                                ...
                                >
                                    <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 1.2 }}>
                                        ...
                                        <Box>
                                            <Typography sx={{ fontWeight: 700, color: 'text.primary', fontSize: '0.92rem', lineHeight: 1.3 }}>
                                                {ref.name}
                                            </Typography>
